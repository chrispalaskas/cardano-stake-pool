...
def main():
    ...
    while True:
        ...
        if sendAssets.main(tokenRecipientList,myPaymentAddrFile, tokenPolicyID, sentTokensLogFile):           
            for new_utxo in diff_utxos:
                sent_utxos_set.add(new_utxo)
            tokenRecipientList = []
        else:
...
if __name__ == '__main__':
    ...
    configFile = '/home/christo/Documents/scripts/sendAssetsToRecipients/config.json'
    try:
